...
public class Apteka {
    ...
    public static void main(String[] args) throws Exception, IOException {
        ...
        while (true){
            String zaProverka=br.readLine().toUpperCase();
            if(zaProverka.equals("KRAJ")){
                break;
            }
            int kol=Integer.parseInt(br.readLine());

            SLLNode<MapEntry<String,Lek>> curr=tabela.search(zaProverka);

            if(curr != null){
                System.out.println(curr.element.value);
                int kolicnaOfCurr=curr.element.value.getKolicina();
                if(kolicnaOfCurr >= kol){
                    System.out.println("Napravena naracka");
                    curr.element.value.setKolicina(kolicnaOfCurr-kol);
            //        tabela.insert(zaProverka,curr.element.value);   NO NEED HERE
                }else{
